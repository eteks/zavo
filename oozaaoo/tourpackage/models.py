...
class Tourpackage(AbstractDefault):
	...
	package_photos = models.ImageField(verbose_name = 'Photos to Upload',upload_to = update_image,max_length = 255)	
	package_document = models.FileField(verbose_name = 'Package Document',upload_to = update_file)	
