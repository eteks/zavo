...
class Tourpackage(AbstractDefault):
	...
	package_photos = models.ImageField(verbose_name = 'Photos to Upload',upload_to = 'images/',max_length = 255)	
	package_document = models.FileField(verbose_name = 'Package Document')	
